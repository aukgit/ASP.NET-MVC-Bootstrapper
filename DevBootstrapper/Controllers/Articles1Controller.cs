...
{
    public class Articles1Controller : GenericController<MagazineEntities> {
		...
		const string ControllerName = "Articles1";
		///Constant value for where the controller is actually visible.
		const string ControllerVisibleUrl = "/Articles1/";
		...
		public Articles1Controller(): base(true){
        ...
        #region Articles1Controller : DropDowns to paste into the partial
